...
```shell
go get github.com/exchange-now/go-binance-th
```
...
import (
    ...
    "github.com/exchange-now/go-binance-th/futures" // optional package
    "github.com/exchange-now/go-binance-th/delivery" // optional package
    "github.com/exchange-now/go-binance-th/options" // optional package
)
```
...
```go
import (
    "github.com/exchange-now/go-binance-th/delivery"
)
